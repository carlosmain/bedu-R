...
ejemplo real de aplicación y tiene que ver con datos referentes a equipos de 
la liga española de fútbol (recuerda que los datos provienen siempre de 
diversas naturalezas), en este caso se cuenta con muchos datos que se pueden 
aprovechar, explotarlos y generar análisis interesantes que se pueden aplicar 
a otras áreas. Siendo así damos paso a las instrucciones:" 
  
"#1. Del siguiente enlace, descarga los datos de soccer de la temporada 
...
# En un solo partido y fue 6 vs 1

# Notas para los datos de soccer:__ https://www.football-data.co.uk/notes.txt